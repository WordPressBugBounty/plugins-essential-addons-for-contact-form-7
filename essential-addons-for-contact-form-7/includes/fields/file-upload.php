...
class File_Upload {
    ...
    public function add_data_handler() {
        if (function_exists('wpcf7_add_form_tag')) {
            wpcf7_add_form_tag(['file_upload', 'file_upload*'], [
                $this,
                'render_uploader'
            ], ['name-attr' => true]);
        }
...
?>
        <span class="wpcf7-form-control-wrap" data-name="<?php echo esc_attr($tag->name); ?>">
            ...
            <span class="eacf7-uploader file-upload">
                ...
                <span class="uploader-hint">
                    <span class="max-files-label <?php echo $max_files < 2 ? 'eacf7-hidden' : ''; ?>"><?php printf(__("Upload upto %s Files.", 'essential-addons-for-contact-form-7'), '<span class="number">' . esc_html($max_files) . '</span>'); ?></span>
                    <span class="max-size-label <?php echo empty($max_size) ? 'eacf7-hidden' : ''; ?>"><?php echo __("Max File Size: ", 'essential-addons-for-contact-form-7') . '<span class="size">' . esc_html($max_size) . ' MB </span>'; ?></span>
                </span>
            </span>
    ...
    public function add_tag_generator() {
        if (version_compare(WPCF7_VERSION, '6.0', '>=')) {
            wpcf7_add_tag_generator(
                'file_upload',
                __('File Upload', 'essential-addons-for-contact-form-7'),
                'file_upload',
        ...
        <header class="description-box">
            <div class="eacf7-notice eacf7-notice-info">
                <p>
                    ...
                    <?php
                    echo sprintf(
                        __('Not sure how to set this? Check our documentation on <a href="%1$s" target="_blank">File Upload</a>', 'essential-addons-for-contact-form-7'),
                        'https://softlabbd.com/docs/file-upload/'
                    );
                    ?>
                </p>
            </div>
        ...
        <div class="control-box">
            ...
            $tgg->print('field_type', array(
                ...
                'select_options' => array(
                    'file_upload' => esc_html__('File Upload', 'essential-addons-for-contact-form-7'),
                ),
            ));
            ...
            <fieldset>
                <legend><?php echo esc_html__('Allowed File Extensions', 'essential-addons-for-contact-form-7'); ?></legend>
                <p class="oneline">
                    <label>
                        <input type="text" data-tag-part="option" data-tag-option="extensions:" name="extensions" placeholder="<?php echo esc_attr__('zip|jpg|png|gif') ?>" />
                        <p><?php echo esc_html__('Enter pipe (|) separated list of allowed file extensions. Leave blank to allow all extensions.', 'essential-addons-for-contact-form-7'); ?></p>
                    </label>
                </p>
            </fieldset>
            ...
            <fieldset>
                ...
                <p class="oneline">
                    <label>
                        ...
                        <p><?php echo esc_html__('Enter the max number of files to allow. If left blank, the value defaults to 1.', 'essential-addons-for-contact-form-7'); ?></p>
                    </label>
                </p>
            </fieldset>
            ...
            <fieldset>
                ...
                <p class="oneline">
                    <label>
                        ...
                        <p><?php echo esc_html__('Check to store uploaded files to Media Library', 'essential-addons-for-contact-form-7'); ?></p>
                    </label>
                </p>
            </fieldset>
    ...
    public function tag_generator_body($contact_form, $args = '') {
        ...
        $description = esc_html__('Generate a form-tag for this upload field.', 'essential-addons-for-contact-form-7');
    ?>
        <div class="control-box">
            <fieldset>
                <div class="eacf7-notice eacf7-notice-info">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description">
                                    <?php echo esc_html__('Check to save uploaded files to media library', 'essential-addons-for-contact-form-7'); ?>
                                </p>
                            </td>
                        </tr>
